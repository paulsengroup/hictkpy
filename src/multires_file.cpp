...
[[nodiscard]] static auto get_resolutions(const MultiResFile& mrf) {
...
void MultiResFile::bind(nb::module_& m) {
  ...
  mres_file.def(
      "__enter__", [](MultiResFile& mrf) -> MultiResFile& { return mrf; },
      nb::rv_policy::reference_internal);

  mres_file.def(
      "__exit__",
      [](MultiResFile& mrf, [[maybe_unused]] nb::handle exc_type,
         [[maybe_unused]] nb::handle exc_value,
         [[maybe_unused]] nb::handle traceback) { mrf.try_close(); },
      // clang-format off
  ...
  mres_file.def(
      "path", [](const MultiResFile& mrf) -> std::filesystem::path { return mrf->path(); },
      "Get the file path.", nb::rv_policy::move);
  mres_file.def(
      "is_mcool", [](const MultiResFile& mrf) { return mrf->is_mcool(); },
      "Test whether the file is in .mcool format.");
  mres_file.def(
      "is_hic", [](const MultiResFile& mrf) { return mrf->is_hic(); },
  ...
  mres_file.def(
      "chromosomes",
      [](const MultiResFile& mrf, bool include_ALL) {
