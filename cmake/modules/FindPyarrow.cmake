...
if(NOT
   ...
   EQUAL
   0
   OR Pyarrow_INCLUDE_DIRS STREQUAL "")
...
if(NOT
   ...
   EQUAL
   0
   OR Pyarrow_LIBRARY_DIRS STREQUAL "")
...
find_package_handle_standard_args(
  ...
  REQUIRED_VARS Pyarrow_INCLUDE_DIRS Pyarrow_LIBRARY_DIRS
...
find_library(
        Pyarrow_LIBRARY arrow_python REQUIRED
        PATHS ${Pyarrow_LIBRARY_DIRS}
        NO_DEFAULT_PATH)
...
if(Pyarrow_FOUND AND NOT TARGET Arrow::python)
  ...
  set_target_properties(Arrow::python PROPERTIES IMPORTED_LOCATION "${Pyarrow_LIBRARY}" IMPORTED_CONFIGURATION
                                                                                            Release)
  ...
  add_custom_target(update_arrow_lib_symlinks BYPRODUCTS "${Pyarrow_LIBRARY}" "${Arrow_LIBRARY}" COMMAND "${Python_EXECUTABLE}" "${SCRIPT}")
  unset(SCRIPT)
...
mark_as_advanced(Pyarrow_VERSION Pyarrow_INCLUDE_DIRS Pyarrow_LIBRARY_DIRS)
